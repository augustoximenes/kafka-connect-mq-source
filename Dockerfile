...
COPY --chown=esuser:esgroup plugins/kafka-connect-mq-source/target/kafka-connect-mq-source-1.3.1-jar-with-dependencies.jar /opt/kafka/plugins/
COPY --chown=esuser:esgroup plugins/jcustenborder-kafka-connect-transform-xml-0.1.0.20/ /opt/kafka/plugins/jcustenborder-kafka-connect-transform-xml-0.1.0.20/
